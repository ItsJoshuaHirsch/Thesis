...
\textbf{ID} & \textbf{Stakeholder-Bezeichnung} 	& \textbf{Organisation (Beispiel)} & \textbf{Gruppe}
  ...
  \\\hline
  4			& Wachenleiter						& \gls{DRK}				& Requirements-Provider
  \\\hline
...
\item Leiter von Rettungswachen
...
\begin{enumerate}
\item \textbf{Leiter von Rettungswachen} \todotext{Personen weiter erläutern}
\item \textbf{Forscher} sdsd
\item \textbf{Ausbilder von Rettungsdienstpersonal} sdsd
\item \textbf{Qualitätsmanagementbeauftragte} sdsd
\item \textbf{Ärzte} sdsd
\end{enumerate}


\subsubsection{Personas}
\todotext{Def. Persona, Aus den in \ref{sub:NutzergruppenAnalyse} analysierten Nutzergruppen von \gls{ANALYSE} ...}
