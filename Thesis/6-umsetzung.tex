...
\code{-GET http://\{SERVER\_IP\}:8080/v3/missionlist/missions/query/start?cql=hasShocks\& batchsize=2000}
...
\begin{enumerate}
\item \code{-POST http://\{SERVER\_IP\}:8080/v3/exports}
\end{enumerate}
...
\begin{enumerate}[resume]
\item \code{-GET http://\{SERVER\_IP\}:8080/v3/exports}
\end{enumerate}
...
\begin{enumerate}[resume]
\item \code{-GET http://\{SERVER\_IP\}:8080/v3/exports/\{EXPORT\_ID\}/file}
\end{enumerate}
...
%(Auszug im Anhang \ref{anhangProbleme})
...
%\todo{Anhang jira stories\ref{AnhangJiraStories?}}
