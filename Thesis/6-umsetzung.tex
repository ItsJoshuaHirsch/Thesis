...
\label{sub:dashboard} %Golden Rules
...
\subsubsection{Neue Visualisierungen durch Erweiterung der Datenobjekte}
...
\todotext{neu reanimationen untereinadner vergleichen, 2. dashboard auch als bild, ccf beeinflußung durch versch faktoren etc.}

\todotext{nibd analog zu defib..}
