...
Die Informationen stammen aus eigener Erfahrung und von dem Web-Auftritt \cite{Qlik.2019} des Unternehmens. 
...
So ist beispielsweise das Symbol \glqq as\grqq{} mit dem dahinter liegenden Befehl \code{alias fieldname as aliasname \{ , fieldname as aliasname\}} deklariert \todotext{ add}\cite{qlik help bnf}.
...
Für größere Teams ab fünf Personen gibt es die Steigerung von Qlik Sense Desktop: Qlik Sense Cloud. \cite{qlik}
