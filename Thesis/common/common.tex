...
%\documentclass[headsepline,footsepline,footinclude=false,parskip=half+, twoside,fontsize=11pt,paper=a4,listof=totoc,bibliography=totoc]{scrbook}% two-sided
% NOTICE PAGEBREAK AFTER MINITOC! MAYBE CHANGE IT!
...
%PDF/A-1b %IMPORTANT: COMMENT THE PAR ABOVE AND A LITTLE DOWN PDF HYPERREF!
%\pdfminorversion=4
...
% Referenzierung mit Name des Kapitels
