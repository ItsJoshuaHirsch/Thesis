...
\item [Blutdruck-Messungen]\hfill \\
...
Einen Entwurf für ein passendes Datenmodell ist in Abbildung \ref{fig:ersterVorschlagDatenmodell} zu sehen.
...
Dabei wurde darauf geachtet, dass keine zirkulären Referenzen entstehen, welche dann vorkommen, wenn mehrere Spalten die gleiche Bezeichnung haben.
...
\subsubsection{Anforderungen für neue Datenquellen (als User Stories in JIRA)}
...
So werden beispielsweise dem Feature \glqq \gls{BI} Dashboard\grqq{} alle zugehörigen Storys zugeordnet, wie in Abbildung \ref{fig:jiraEpic} zu sehen.
\bild
{jiraEpic}
{11cm}
{Grafische Visualisierung der zugehörigen Storys vom Feature \glqq \gls{BI} Dashboard\grqq{} in Jira}
{Grafische Visualisierung der zugehörigen Storys vom Feature BI-Dashboard in Jira}
...
Für das Extrahieren und Exportieren von einem neuen Datenobjekt ist es daher sinnvoll, die geforderten Informationen so detailliert wie möglich zu beschreiben.
...
\todotext{Story Beispiel mit Bild und Tabelle etc.}
